...
export default function Home() {
    // const container= "border border-gray-600 border-t-0";
    
  return (
            <div className="border border-gray-600 h-auto   border-t-0 max-lg:w-2/3 max-sm:w-full">
                <div className="flex max-sm:hidden">
                    <div className="flex-1 mt-3">
                        <h2 className="px-2 py-2 text-xl font-semibold text-white">Home</h2>
                    </div>
                    <div className="flex-1 px-4 py-2 m-2">
                        <Link to={''} className=" text-2xl font-medium rounded-full text-white hover:bg-blue-800 hover:text-blue-300 float-right">
                ...
                <div className="sm:hidden flex px-10 justify-between items-center h-[60px]">
                   ...
                   <img className="w-[40px] h-[40px]" src="https://logohistory.net/wp-content/uploads/2023/02/Twitter-Log%D0%BE.svg"/>                  
                    <SettingsIcon/>
                </div>
            ...
            <div className="flex flex-shrink-0 p-2 pb-0 width-auto">
                <Link to={''} className="flex-shrink-0 group block">
                  <div className="flex  items-center">
                    ...
                    <div className="flex items-center justify-between   max-sm:flex-col max-sm:items-start pl-3">
                        <p className="text-base leading-6 font-medium text-white">Sonali Hirave </p>
                        <span className="text-sm ml-2 max-sm:ml-0 leading-5 font-medium text-gray-400 group-hover:text-gray-300 transition ease-in-out duration-150">
            ...
            <div className="pl-16">
                <p className="text-base width-auto font-medium max-sm:text-sm/[19px] text-white flex-shrink mt-5 ">
                ...
                {/* <div className="flex w-2/3 items-center">
                            <div className="text-center w-1/6">
                                <Link to={''} className="w-12 mt-1 group flex items-center text-gray-500 px-0 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300">
                            ...
                            <div className=" text-center py-2 m-2 w-1/6">
